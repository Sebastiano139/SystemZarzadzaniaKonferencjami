...
(
	...
	Limit int not null
		constraint CK_Conferences_Limit
			check ([Limit]>0),
	Canceled bit constraint DF_Conferences_Canceled default 0 not null,
	Price money constraint DF_Conferences_Price default 0 not null,
	CityID int not null
...
(
	...
	Date date not null,
	Canceled bit constraint DF_ConferencesDays_Canceled default 0 not null
)
go
